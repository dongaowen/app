            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click="changeOrder('1')">
                  <a href="#">综合<span v-show="isOne" class="iconfont" :class="{'icon-pullup': isAsc, 'icon-pulldown': isDesc}"></span></a>
                </li>
                <li :class="{active: isTwo}" @click="changeOrder('2')">
                  <a href="#">销量<span v-show="isTwo" class="iconfont" :class="{'icon-pullup': isAsc, 'icon-pulldown': isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //排序的操作
      changeOrder(flag) {
        if (this.searchParams.order.indexOf(flag)) {
          this.searchParams.order = `${flag}:desc`
        } else {
          // this.searchParams.order = this.searchParams.order.indexOf('desc') !== -1 ? `${flag}:asc` : `${flag}:desc`
          this.searchParams.order = `${flag}:${this.searchParams.order.indexOf('desc') !== -1 ? 'asc' : 'desc'}`
        }
        this.getSearchList(this.searchParams)
      },
      //获取当前分页数
